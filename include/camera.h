...
private:
  ...
  double _min_x_diff;// _max_x_diff = _bf / _depth_lower_thr;
  double _max_x_diff;// _min_x_diff = _bf / _depth_upper_thr;
  double _max_y_diff;// _max_y_diff = camera_configs["max_y_diff"];
